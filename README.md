...
To build the docker image for api.products run the command below from the root of the `api.products` directory
...
NOTE: Make sure the api.orders and api.products container are running.
